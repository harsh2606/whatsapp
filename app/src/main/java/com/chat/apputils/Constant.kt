...
object Constant {
    ...
    const val ALLVEHICLE = "All Vehicle"
    const val EDITVEHICLE = "Edit Vehicle"
    const val CYCLE = "Cycle"
    const val RICKSHAW = "Rickshaw"
    const val CAR = "Car"
    const val BIKE = "Bike"
    ...
    const val MENU_HISAB = "hisab"
    const val MENU_MAINTENANCE = "maintenance"
    const val MENU_COMPLAINTS = "complaints"
    const val MENU_EVENTS = "events"
