...
import com.chat.apputils.RequestParamsUtils
...
//                        context.startActivity(intent)
    ...
    fun newRequestPostJson(activity: Context, url: String, json: String): Call {
        val JSON = "application/json; charset=utf-8".toMediaTypeOrNull()
//            var legacyServerKey = if (BuildConfig.IS_SANDBOX) {
//                activity.gets
//            } else {
//                Constant.FCM_LEGACY_SERVER_KEY
//            }
        ...
        val request = okhttp3.Request.Builder()
            .addHeader(
                ...
                "key=" + activity.getString(R.string.google_fcm_server_key)
            ) // Change a
